...
* **Intelligence & Local Inference Engine:** Ollama running Qwen 3 (8B Reasoning Model), Llama 3.1 (8B Execution Model) & nomic-embed-text (High-Dimensional Vector Model)
